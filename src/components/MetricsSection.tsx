...
const AnimatedCounter = ({
  ...
  return <motion.div ref={ref} className="text-center" initial={{
    opacity: 0,
    y: 50
  }} animate={{
...
const MetricsSection = () => {
  ...
  return <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-6">
        ...
        {/* Visual separator */}
        <motion.div className="mt-16 h-px bg-gradient-to-r from-transparent via-border to-transparent" initial={{
        scaleX: 0
      }} whileInView={{
        scaleX: 1
      }} viewport={{
